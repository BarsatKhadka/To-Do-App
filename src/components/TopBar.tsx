...
export default function TopBar() {
  return (
    <Navbar>
      <NavbarBrand>
        <AcmeLogo />
        <p className="font-bold text-inherit ml-3">To Do App</p>
      </NavbarBrand>
